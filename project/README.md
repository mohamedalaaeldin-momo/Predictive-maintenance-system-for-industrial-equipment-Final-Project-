...
مشروع تخرج متكامل (Full-Stack) يستقبل قراءات حساسات ماكينة صناعية في الوقت الفعلي، ويستخدم نموذج تعلّم آلي مُدرَّب مسبقًا للتنبؤ بما إذا كانت الماكينة في طريقها للعطل وتحتاج صيانة، أو أنها تعمل بشكل طبيعي. المشروع يستبدل واجهة Gradio التجريبية بواجهة ويب حديثة مبنية بـ Next.js، مع خلفية (Backend) مبنية بـ FastAPI، وكلاهما جاهز للنشر على Vercel بدون Docker.
